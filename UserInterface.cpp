...
inline int UserInterface::calcMaxColumnSize(int const colNum, CellVector2D spreadsheet)
{
	size_t maxSize = 0;
...
void UserInterface::getInput(size_t &sizeX, size_t &sizeY, StringVector2D &inputValues) {
...
void UserInterface::printOutput(CellVector2D spreadsheet) {
